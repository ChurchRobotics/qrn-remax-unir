...
import { ScrollView as RScrollView, View } from '@remax/toutiao'
...
class ScrollView extends React.Component {
    ...
    render() {
        ...
        if(horizontal && !wx.canIUse('scroll-view.enable-flex')){
            children = <View style={StyleSheet.flatten([{display: 'flex', flex: 1, width: '100%', height: '100%', flexDirection: 'row'}, contentContainerStyle])}>{children}</View>
        }
        return <RScrollView
